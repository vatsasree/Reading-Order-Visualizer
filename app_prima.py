...
# Load the JSON data
with open('/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/temp_jsonsfromada/dic_prima_chebyshev_no_margins_yolo.json','r') as json_file:
# with open('/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/jsons/prima/dic_prima_chebyshev_no_margins_yolo.json', 'r') as json_file:
# with open('/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/yolo_json/prima.json', 'r') as json_file:
...
def final_orderr():
    ...
    font_size = request.args.get('font_size', default=1, type=float)
...
def save_csv_good_bad():
    ...
    if 0 <= image_index < total_images:
        ...
        component_df_1 = ignore_margins(component_df,width_p,header_p,footer_p,image_path)
        #<function to ignore header and footer>
        boxes_df, message = save_csv(component_df_1, euclidean_df_2,image,image_path,attributes,classification, doc_category)
