...
IMAGE_FOLDER = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/static/images/data/prima'
...
def show_image(image_index):
    if 0 <= image_index < total_images:
        ...
        for ext in possible_extensions:
            ...
            image_path = f'images/data/prima/{current_image}{ext}'
            if os.path.exists(os.path.join(IMAGE_FOLDER.split('images/data/prima')[0],image_path)):
                break
        else:
            return "Image file not found."
        return render_template('index_layout.html', image_path=image_path, current_image=current_image, image_files=image_files)
    else:
...
def show_image_layout(image_index):
    # json_path = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/yolo_json/extended_dataset/chinese_sahithi_best.json'
    # json_path = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/yolo_json/extended_dataset/extended_dataset_best.json'
    # json_path = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/yolo_json//extended_dataset/extended_dataset_md2.json'
    # json_path = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/yolo_json/full_dataset_best.json'
    # json_path = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/yolo_json/full_ro_dataset_md2.json'
    # json_path = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/yolo_json/Dataset.json'
    # json_path = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/yolo_json/DocLayNet.json'
    # json_path = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/yolo_json/prima.json'
    # json_path = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/yolo_json/researchpapers.json'
    # json_path = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/yolo_json/textbooks.json'
    # json_path = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/yolo_json/yojana.json'
    # json_path = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/distractor_region_model/distractor_layout_regions/loksabha.json'
    json_path = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/distractor_region_model/indic_model_jsons/prima/json/prima.json'
    ...
    if 0 <= image_index < total_images:
        ...
        img_with_layout = display_layout(img_path, f)
        ...
        return render_template('index_layout.html', current_image=current_image.split('.')[0], image_path='/images/output_images/output_img_with_gts.jpg', image_files=image_files)

    else:

        # return "Invalid image index"
        print("Invalid image index")
        return render_template("index_layout.html", current_image=None,image_path=None,image_files=image_files, error_message="Invalid image index")
