...
IMAGE_FOLDER = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/static/images/Pagg/LokSabha'
...
# with open('/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/jsons/dataset/dic_dataset1_chebyshev_no_margins.json' , 'r') as json_file_5:
#     image_data_5 = json.load(json_file_5)

with open('/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/temp_jsonsfromada/loksabha/dic_dataset_chebyshev_no_margins_yolo_v2_100tofull_1.json','r') as json_file_4:
    image_data = json.load(json_file_4)

with open('/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/temp_jsonsfromada/loksabha/dic_dataset_chebyshev_no_margins_yolo_v2_100tofull_2.json','r') as json_file_5:
    image_data_5 = json.load(json_file_5)
...
def show_image(image_index):
    if 0 <= image_index < total_images:
        ...
        image_path = 'images/Pagg/LokSabha/' + current_image
...
def para_image_1(image_index):
    ...
    if 0 <= image_index < total_images:
        ...
        #return render_template('conn_image.html', image_path=temp_output_path)
        return render_template('index_final.html', current_image=current_image, image_path='/images/output_images/output_para_image.jpg', image_files=image_files, error_message=None)
...
if __name__ == '__main__':
    app.run(host="0.0.0.0",debug=True, port=4998)
