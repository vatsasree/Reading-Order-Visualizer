...
def show_image(image_index):
    if 0 <= image_index < total_images:
        ...
        return render_template('index_hisam_lines_paras_ro.html', image_path=image_path, current_image=current_image, image_files=image_files)
    else:
...
@app.route('/display_lines/<int:image_index>>')
def show_image_lines(image_index):
    json_path = '/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/lines_paras_jsons/lines_paragraphs_extended_RO_dataset.json'
    ...
    if 0 <= image_index < total_images:
        ...
        img_with_layout = display_hisam_lines(img_path, f['lines'])
        ...
        return render_template('index_hisam_lines_paras_ro.html', current_image=current_image.split('.')[0], image_path='/images/output_images/output_img_with_gts.jpg', image_files=image_files)

    else:

        # return "Invalid image index"
        print("Invalid image index")
        return render_template("index_hisam_lines_paras_ro.html", current_image=None,image_path=None,image_files=image_files, error_message="Invalid image index")
...
def show_image_paras(image_index):
    ...
    if 0 <= image_index < total_images:
        ...
        img_with_layout = display_hisam_paras(img_path, f['paragraphs'])
