...
# IMAGE_FOLDER = "/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/static/images/Pagg/textbooks"
IMAGE_FOLDER = "/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/static/images/final_images_combined"
app.config['UPLOAD_FOLDER'] = IMAGE_FOLDER

# Load the JSON data
with open('/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/temp_jsonsfromada/hi_sam/hi_sam_best/dic_dataset_chebyshev_no_margins_yolo_v2_full_ro_hisam_1.json','r') as json_file:
    image_data = json.load(json_file)

with open('/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/temp_jsonsfromada/hi_sam/hi_sam_best/dic_dataset_chebyshev_no_margins_yolo_v2_full_ro_hisam_2.json','r') as json_file:
    image_data_2 = json.load(json_file)

with open('/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/temp_jsonsfromada/hi_sam/hi_sam_best/dic_dataset_chebyshev_no_margins_yolo_v2_full_ro_hisam_3.json','r') as json_file:
    image_data_3 = json.load(json_file)

with open('/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/temp_jsonsfromada/hi_sam/hi_sam_best/dic_dataset_chebyshev_no_margins_yolo_v2_full_ro_hisam_4.json','r') as json_file:
    image_data_4 = json.load(json_file)

with open('/home/vatsasree/Research/scripts/applic/Reading-Order-Visualizer/temp_jsonsfromada/hi_sam/hi_sam_best/dic_dataset_chebyshev_no_margins_yolo_v2_full_ro_hisam_5.json','r') as json_file:
    image_data_5 = json.load(json_file)   

image_data.update(image_data_2)
image_data.update(image_data_3)
image_data.update(image_data_4)
image_data.update(image_data_5)

print(len(image_data.keys()))
...
image_files_json_jpeg = [f+'.jpeg' for f in image_files_json]
print("Image files json jpeg:",len(image_files_json))

image_files_json_jpg = [f+'.jpg' for f in image_files_json]
print("Image files json jpeg:",len(image_files_json))

image_files_json_png = [f+'.png' for f in image_files_json]
print("Image files json jpeg:",len(image_files_json))

image_files_json = image_files_json_jpeg + image_files_json_png + image_files_json_jpg
...
def show_image(image_index):
    if 0 <= image_index < total_images:
        ...
        # image_path = 'images/Pagg/textbooks/' + current_image
        image_path = 'images/final_images_combined/' + current_image
